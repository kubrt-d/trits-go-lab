...
func NewTritsSquad(banker TritsBanker) TritsSquad {
	...
	all[8] = NewTritsPlayerFactory(NewTritsAddress(NiobeAddr), banker, "agent")
	all[9] = NewTritsPlayerFactory(NewTritsAddress(PersephoneAddr), banker, "agent")
	all[10] = NewTritsPlayerFactory(NewTritsAddress(TwinsAddr), banker, "agent")
